...
export default function OurProgramForm() {
  ...
  const handleSubmit = (e) => {
    ...
    const requiredFields = [
      'slug','title','githubLink','description','division','date',
      'divisionImage','image','image2',
    ...
    alert("Our Program berhasil disimpan!");
  };
    ...
    <div className="grid grid-cols-[260px_1fr] min-h-screen bg-gray-100">
      ...
      <div className="flex items-start p-8 pt-20">
        <div className="bg-white w-full rounded-xl p-10 shadow">
          ...
          <h2 className="text-2xl font-bold mb-8">Our Program</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* ✅ IMAGE DIPINDAH KE SINI (SETELAH DIVISION) */}
            <div>
